...
const CreatePost = () => {
  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch("https://di-mage.onrender.com/api/v1/dalle", {
          method: "POST",
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      ...
      try {
        const response = await fetch("https://di-mage.onrender.com/api/v1/post/", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
      ...
      <form action="" className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">
            Lorem ipsum dolor sit amet couam officia facere eos dignissimos
            eaque cupiditate enim facilis officiis!
          </p>
